...
module.exports.execute = async (client, message, args) => {
    ...
    message.channel.csend(`**${victim}(${victim.username})** kullanıcısı ${message.author} tarafından **"${reason}"** sebebiyle geçici olarak susturuldu. (Ceza Numarası: \`#${document.Id}\`)`)
