...
module.exports.execute = async (client, message, args) => {
    ...
    if (penalId) {
        ...
        message.reply(`<:UnchatMuted:815668871222001704> ${member ? member.displayName : victim.username}(${victim.id}) kullanıcısının \`#${penalId}\` numaralı susturma cezasını kaldırdın. ✅`);
    }
