...
module.exports.execute = async (client, message, args) => {
    ...
    message.channel.csend(`<:Muted:815110585242091530> **${victim}(${victim.username})** kullanıcısı ${message.author} tarafından **"${reason}"** sebebiyle  geçici olarak sesli susturuldu. (Ceza Numarası: \`#${document.Id}\`)`)
