...
module.exports.execute = async (client, message, args) => {
    ...
    if (reply.content.toLocaleLowerCase().includes("evet")) {
        ...
        message.reply(`<:UnMuted:815110583706976307> ${victim} kullanıcısının sunucudaki tüm sesli sohbet cezaları başarılı bir şekilde kaldırıldı. ✅`);
    }
    else message.reply("başlatmış olduğun tüm sesli sohbet cezalarını kaldırma işlemi iptal edildi. ❌");
}

module.exports.settings = {
    Commands: ["unvoicemuteall", "uvmall", "unvcmute"],
