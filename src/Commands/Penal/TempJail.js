...
module.exports.execute = async (client, message, args) => {
    ...
    message.channel.csend(`**${victim}(${victim.username})** kullanıcısı ${message.author} tarafından **"${reason}"** sebebiyle geçici olarak cezalandırıldı. (Ceza Numarası: \`#${document.Id}\`)`)
