...
module.exports.execute = async (client, message, args) => {
    ...
    message.channel.csend(`**<:Muted:815668871033520159> ${victim}(${victim.username})** kullanıcısı ${message.author} tarafından **"${reason}"** sebebiyle sesli susturuldu. (Ceza Numarası: \`#${document.Id}\`)`)
...
module.exports.settings = {
    Commands: ["voicemute", "seslisustur", "vcmute"],
